...
var colourBackground = "#9966cc";	//"#3796E3";		//This is your base colour (Change this)
var colourText = "#9999cc"; //shadeColor(colourBackground,70);	//This is calculated from your base colour (but can be a custom HEX)
var colourLoadingBack = "#330033"//shadeColor(colourBackground,-10);	//This is calculated from your base colour (but can be a custom HEX)
var colourLoadingFront = "#33cc33"//shadeColor(colourBackground,70);	//This is calculated from your base colour (but can be a custom HEX)
