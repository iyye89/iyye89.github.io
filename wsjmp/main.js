...
///<reference path='src/ImportTS.d.ts' />
var Main = (function (_super) {
    ...
    Main.prototype.applicationDidFinishLaunching = function () {
        ...
        rr.ResPathManager.KEYWORD_TXT = ["xxx"];
        //多国初始化
    ...
    Main.prototype.preLoadFinish = function () {
        ...
        //读取spilAPI;
        rr.Localization.loadAPI("576742227280292468");
...
//        this.startGame();
    ...
    Main.prototype.adjustSizeForWindow = function () {
        ...
        if (screenSize.width >= Root.MAX_STAGE_WH.width || tx.isIosSys()) {
            screenSize.width = Root.MAX_STAGE_WH.width;
        }

        if (screenSize.height >= Root.MAX_STAGE_WH.height || tx.isIosSys()) {
