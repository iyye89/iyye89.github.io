...
(function(t) {
    ...
    function i(t, e) {
        t = t || {}, this.IS_MASTER = t.isMaster, this.IS_SLAVE = !this.IS_MASTER, this.moduleReady = e ? e : !1, this.messenger = t.messenger, this.data = t.data || null
    }
    ...
    function a(t, e) {
        t = t || {}, this.isMaster = t.isMaster, this.isStandalone = t.isStandalone, this.messenger = t.messenger, this.eventTracking = t.eventTracking, this.moduleReady = e ? e : !1, this.events = {
    ...
    function d(t, n, o, s, u) {
        this.version = "0.11.1", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new t({
            isMaster: !0
    ...
    (function(t) {
        ...
        function N(t) {
            return g(t, function(t) {
                return t = K(t, p), g(G(K(t, function(t) {
                    return g(t, H, H)
                })), function() {
                    return t
                })
        ...
        }, p.isRejected = b, f.prototype.isRejected = function() {
        ...
        p.resetUnhandledRejections = w, p.getUnhandledReasons = function() {
            ...
            w(), oe = !1
        }, w(), p.reject = T, p.fulfill = k, p.master = M, p.spread = R, f.prototype.spread = function(t, e) {
    ...
    m.getGameConfig = function() {
        ...
        return this.isMaster || this.messenger._postMessage(["log.gameapi.score.submit", {
                origin: "slave",
                score: t
            },
            null
        ], null, "log"), "function" == typeof SWFtoJS && SWFtoJS({
        ...
        this.messenger, this.isMaster && this.messenger.subscribe("gameapi.gameevent", this.emit, this)
        ...
        var n = e || {};
        if (!this.moduleReady) throw Error("This method cannot be called before the API is loaded");
        this._validateEvent(t) ? (this.eventTracking._createEventObject("game", t, n), this.isMaster ? "function" == typeof SWFtoJS && SWFtoJS({
            call: t
            ...
            null
        ], null, "log"))) : this.isMaster || this.messenger._postMessage(["log.gameapi.gameevent.emit", {
                origin: "slave"
            },
            null
        ], null, "log")
        ...
        return n = "string" == typeof e ? e : "logo", r = "brandedgames_" + (s > 0 && 500 > s ? "internal" : "external"), i = ["utm_medium=" + r, "utm_campaign=" + a.applicationId, "utm_source=" + o.host, "utm_content=" + n].join("&"), t += t.indexOf("?") > -1 ? "&" : "?", "http://www.6m5m.com"
        ...
        function n(e) {
            return a.IS_MASTER && (e = r(e)), a.isReady = !0, a.Branding.moduleReady = !0, a.__.EventTracking.moduleReady = !0, a.GameBreak.moduleReady = !0, a.Game.moduleReady = !0, a.Score.moduleReady = !0, a.GameEvent.moduleReady = !0, a.Branding.init({
                data: e
        ...
        return !0 === this.isReady ? (window.console && window.console.log && console.log("WARNING: Detected multiple executions of GameAPI.loadAPI(). This method should only be executed once per page load!"), t(a)) : (this.__.messenger._postMessage(["log.gameapi.loadapi.start", {
            ...
            null
        ], null, "log"), this.IS_STANDALONE ? (e = e || null, m.setupStandaloneMode(e, function(t) {
            a.__.dataStore._setCache(r(t)), n(t)
        })) : this.IS_MASTER ? m.getGameConfig().then(function(t) {
