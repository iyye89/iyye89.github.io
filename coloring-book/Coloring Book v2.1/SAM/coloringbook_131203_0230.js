...
function _KM() {
    if (_HM != _IM) return;
    _LM = g_WebAudioContext.createGainNode();
    _LM.connect(g_WebAudioContext.destination);
    _JM = g_WebAudioContext.createGainNode();
    _JM.connect(_LM);
    _MM(_vM._xM);
...
function _MM(_TM) {
    var _UM = g_WebAudioContext.createPanner();
...
function _OM(__M, _0N, _1N) {
    if (_HM == _IM) {
        g_WebAudioContext.listener.setPosition(__M, _0N, _1N)
    }
}

function _PM(__M, _0N, _1N, _2N, _3N,
    _4N) {
    if (_HM == _IM) g_WebAudioContext.listener.setOrientation(__M, _0N, _1N, _2N, _3N, _4N)
}
        ...
        if (_6N >= _jM) {
            ...
            if (_iM[__M] != undefined) {
                if (!_iM[__M].paused) {
                    _iM[__M]._WM.noteOff(0);
                    _iM[__M].paused = !0;
                    _iM[__M].playbackpoint += g_WebAudioContext.currentTime - _iM[__M]._bN
                }
            }
        } else {
            for (_B1 = 0; _B1 < _kM - _jM; _B1++) {
...
function _ZM(_6N) {
    ...
    if (_6N >= _jM) {
        ...
        if (_iM[__M] != undefined) {
            if (_iM[__M].paused) {
                _iM[__M]._WM = g_WebAudioContext.createBufferSource();
                _iM[__M]._bN = g_WebAudioContext.currentTime;
                _iM[__M]._7N = g_WebAudioContext.createGainNode();
...
var _U61 = -1,
    _V61 = 0,
    _IM = 1;
var global = _wH = _aM = _Pz = _gM = _v4 = _VC = _W61 = _X61 = _Y61 = _bW = _vL = _NE = _wC = _Z61 = _lz = __61 = _oz = _071 = _171 = _271 = _371 = _hA = _471 = _571 = _pA = _671 = _FJ = _FA = _9B = _uz = _771 = _iR = _wE = _vE = _871 = _yE = _971 = _a71 = _b71 = _c71 = _LT = _MT = _d71 = _e71 = _tz = _YO = _XO = _ZO = __O = _f71 = _g71 = _h71 = _i71 = _j71 = _k71 = _l71 = _m71 = _n71 = _o71 = _p71 = _LM = _JM = g_WebAudioContext = _GC = _eC = _q71 = null,
    _HM = _V61,
    _r71 = _s71 = !0,
